      ...
      <div className="stack items-center gap-6">
        ...
        <div className="stack w-full items-center gap-4">
          <SubmitButton
            ...
            className="w-full flex gap-2 items-center justify-center font-semibold py-3 px-7 text-base hover:bg-primary-light disabled:cursor-not-allowed disabled:hover:bg-primary-lightest"
          >
