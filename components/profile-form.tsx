...
export default function ProfileForm() {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="bg-white grow rounded-xl stack max-h-full">
      <div className="p-6 md:p-10 stack gap-10 grow max-h-full">
        ...
        <div className="stack gap-6">
          <div className="stack gap-6 text-gray mb-6">
            <div className="w-full flex flex-col rounded-xl md:flex-row gap-4 md:items-center p-5 bg-gray-light justify-between">
          ...
          <div className="rounded-lg bg-gray-light p-5 text-gray stack gap-3">
            <div className="flex flex-col gap-1 md:gap-4 md:flex-row md:items-center justify-between">
              <Label htmlFor="email" className="md:text-base shrink-0">
                First name*
              </Label>
              <InputWithIcon
                id="firstName"
